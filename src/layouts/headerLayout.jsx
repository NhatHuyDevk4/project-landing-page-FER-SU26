...
const HeaderLayout = () => {
  return (
      <header class="bg-gray-900 sticky top-0 z-50 ">
        <nav
          aria-label="Global"
          class="mx-auto flex  items-center justify-between p-6 lg:px-8 border-gray-50/20 border-b pb-1"
        >
          ...
          <el-popover-group class="hidden lg:flex lg:gap-x-12">
            ...
            <Link to="/about" class="text-sm/6 font-semibold text-white">
              About
            </Link>
            <Link to="/products" class="text-sm/6 font-semibold text-white">
              list product
            </Link>
          </el-popover-group>
         <div className="hidden lg:flex lg:flex-1 lg:justify-end ">
           <button className="text-sm/6 font-semibold leading-6 bg-gray-600 border rounded-md px-3 py-1 text-white hover:bg-gray-500 cursor-pointer">
            log in
          </button>
         </div>
        </nav>
